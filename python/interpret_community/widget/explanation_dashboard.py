...
class ExplanationDashboard:
    ...
    class DashboardService:
        ...
        if nbvm is None:
            ...
            cross_origin(origins=[nbvm_origin_global, nbvm_origin2_global], allow_headers=['Content-Type','Authorization'], expose_headers=['POST', 'GET', 'OPTIONS'], supports_credentials=True, automatic_options=False, send_wildcard=True)(predict)
